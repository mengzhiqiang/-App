...
- (IBAction)rechargeAction:(UIButton *)sender {
    [self.navigationController pushViewController:[SARechargeVC viewControllerWithXib] animated:YES];
}
