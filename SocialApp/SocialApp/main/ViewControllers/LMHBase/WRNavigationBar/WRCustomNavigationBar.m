...
#pragma mark 导航栏样子修改
-(void)setNavigationUITitle:(NSString*)title{
    
    self.height = 109 + iphoneXTop;
    self.title = title;
    self.titleLabelFont = [UIFont boldSystemFontOfSize:26];
    ...
    self.barBackgroundImage = [UIImage imageNamed:@"sy_bg"];

    self.barBackgroundColor = Main_Color;
    self.backgroundColor= Main_Color;
    self.backgroundImageView.height = self.height;
    self.backgroundView.backgroundColor = Main_Color;
