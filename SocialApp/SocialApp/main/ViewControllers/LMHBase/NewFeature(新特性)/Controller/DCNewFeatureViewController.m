...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.nfImageView.image = (IS_X_) ? [UIImage imageNamed:[NSString stringWithFormat:@"%@_x",_imageArray[indexPath.row]]]  : [UIImage imageNamed:_imageArray[indexPath.row]];
    ...
    cell.hideButtonClickBlock = ^{
        ...
        [weakself restoreRootViewController:[[LMHTabBarViewController alloc] init]];
    };
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    if (scrollView.contentOffset.x >  (_imageArray.count - 1) * SCREEN_WIDTH) {
        [self restoreRootViewController:[[LMHTabBarViewController alloc] init]];
    }
}
