...
#define KJFDefaultLabelFont         [UIFont systemFontOfSize:14 weight:UIFontWeightLight]
...
@property (nonatomic, assign) CGFloat textCorner; // textLabel 距气泡边框因圆角产生的左右额外距离
