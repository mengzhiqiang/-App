...
- (void)viewDidLoad {
    ...
    [self.customNavBar wr_setRightButtonWithTitle:@"提交" titleColor:Black_Color];
    WS(weakself);
...
//    }
//    [self dismissViewControllerAnimated:YES completion:nil];
    EMCreateGroupViewController *createController = [[EMCreateGroupViewController alloc] initWithSelectedMembers:self.selectedArray];
    createController.inviteController = self;
