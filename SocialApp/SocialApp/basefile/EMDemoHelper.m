...
- (void)handlePushChatController:(NSNotification *)aNotif
{
    ...
    if (model) {
        ...
        if ([rootViewController isKindOfClass:[UINavigationController class]]) {
            ...
            [[UIViewController getCurrentController].navigationController pushViewController:controller animated:YES];
...
//    PLQRCodeViewController * qcVC = [PLQRCodeViewController new];
//    
////    EMChatroomsViewController *controller = [[EMChatroomsViewController alloc] init];
//    [navController pushViewController:qcVC animated:YES];
}
