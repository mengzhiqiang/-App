...
- (void)viewDidLoad {
    ...
    self.page = [[UIPageControl alloc]initWithFrame:CGRectMake(SCREEN_WIDETH/2 - 50, SCREEN_HEIGHT - 80, 100, 20)];
...
//            
//            UIImageWriteToSavedPhotosAlbum(self.imagesArr[sender.view.tag], self, @selector(imageSavedToPhotosAlbum:didFinishSavingWithError:contextInfo:), nil);
//        }];
